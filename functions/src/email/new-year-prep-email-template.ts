/**
 * New Year Preparation email template with flat icons
 * Sent annually on December 28th to all users
 */

export function getNewYearPrepEmailHTML(displayName: string, frontendUrl: string, nextYear: number): string {
  return `
    <!DOCTYPE html>
    <html>
    <head>
