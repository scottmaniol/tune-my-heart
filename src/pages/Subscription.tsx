...
const Subscription = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header - Different for family accounts */}
      <div className="card">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-heading text-primary mb-2 flex items-center gap-3">
              ...
              {accountType === 'family' ? 'My Subscription' : 'Subscription Management'}
            </h1>
            <p className="text-text-light font-body">
              {accountType === 'family' 
                ? 'View your plan and features' 
      ...
      {/* Past Due Warning - Only for individual accounts */}
      ...
      {/* Actions Card - Only show to individual (non-family) accounts */}
      {accountType !== 'family' && (
        <div className="card">
