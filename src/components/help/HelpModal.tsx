...
import { X, ChevronDown, ChevronRight, HelpCircle, BookOpen, Church, Music, Lightbulb, Baby, Settings, Crown, Users, Calendar, Info } from 'lucide-react';
      ...
      content: (
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            ...
            <div className="bg-blue-50 p-3 rounded">
              <h4 className="font-semibold text-text mb-1">"Next Unread" Button</h4>
              <p className="text-sm text-text-light">Quickly jump to your next unread reading in the schedule. Only appears when you have unread readings and it differs from today's date. Perfect for catching up when you're behind!</p>
            </div>
            <div className="bg-blue-50 p-3 rounded">
  ...
  return (
    <>
      <div 
        ...
        onClick={onClose}
      />
      <div className="fixed inset-4 sm:inset-8 md:inset-16 lg:inset-24 xl:inset-32 z-50 flex items-center justify-center">
        <div className="bg-white rounded-lg shadow-2xl w-full max-w-5xl max-h-full overflow-hidden flex flex-col">
          {/* Modal Header */}
          <div className="bg-primary px-6 py-4 flex items-center justify-between border-b border-primary-dark flex-shrink-0">
            <div className="flex items-center gap-3">
              <HelpCircle className="w-8 h-8 text-white" />
              <h2 className="text-2xl font-heading text-white font-bold">Help & Documentation</h2>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="overflow-y-auto p-6 flex-1">
            ...
            <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-sm text-text font-body text-center">
                ...
                <a href="mailto:support@tunemyheart.app" className="text-primary underline">
                  support@tunemyheart.app
                </a>
              </p>
            </div>
          </div>
